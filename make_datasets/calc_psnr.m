close all;
clear;
% i1 = imread('E:\Project\VideoEnhancement\VDSR\results\gt\4_gt_.png');
up_scale = 4;   % 缩放比例
file_path = 'E:\Project\VideoEnhancement\VDSR\results\output\';% 图像文件夹路径
file_path_gt = 'E:\Project\VideoEnhancement\VDSR\results\gt\';% 图像文件夹路径
